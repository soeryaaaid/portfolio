...
export const ProjectGrid = ({ projects }: { projects: ProjectItem[] }) => {
  ...
  return (
    <div id="projects" className="py-20 bg-zinc-950 text-white px-4 md:px-8 border-t border-zinc-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-10">
          {projects.map((project) => (
            <div
              key={project.title}
              className="group relative flex flex-col rounded-3xl border border-zinc-800 bg-zinc-900/40 backdrop-blur-md overflow-hidden hover:border-cyan-500/30 transition-all duration-300 shadow-xl"
            >
              ...
              <div className="p-6 md:p-8 flex flex-col flex-grow">
                ...
                <p className="text-zinc-400 text-sm md:text-base leading-relaxed mb-6 flex-grow">
                  {project.description}
                </p>
                ...
                <div className="pt-4 border-t border-zinc-800 flex justify-between items-center">
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-sm font-semibold text-white bg-zinc-900 border border-zinc-700 hover:border-white px-4 py-2 rounded-full transition-all"
                  >
